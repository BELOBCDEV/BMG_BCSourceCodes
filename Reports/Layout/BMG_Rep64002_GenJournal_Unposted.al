report 64002 BMGGeneralJournalUnposted
{
    Caption = 'List of Unposted Gen. Jnl.';
    ...
    dataset
    {
        dataitem(GJBatch_General; "Gen. Journal Batch")
        {
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = '.\Reports\Layout\GenJournal_Unposted.rdl';
        }
    }
    ...
    var
        ...
        lblReportCaption: Label 'GENERAL JOURNAL BATCHES';
